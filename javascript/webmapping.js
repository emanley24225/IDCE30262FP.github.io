...
var fridge_icon1 = L.icon({
    ...
    var fridge_marker1 = L.marker([42.251569, -71.819814], {icon: fridge_icon1}).addTo(fridge);{}
          fridge_marker1.bindPopup("<b>Main Street Fridge</b><br> <p> The Woo Fridge Project aims to help people struggling with food insecurity in the Worcester area. There are three fridges which are continually stocked by members of the community located around Worcester. Those in need of food can travel to the fridge closest to them to find groceries they need. This fridge is located on Main Street near Clark University.</p> <br> <p>910 Main St Worcester, MA</p> <br> <a href= https://www.worcestercommunityfridges.com/ /> Here is the website </a>").openPopup();
    ...
    var fridge_marker2 = L.marker([42.253743, -71.806600], {icon: fridge_icon1}).addTo(fridge);{}
        fridge_marker2.bindPopup("<b>Southbridge Fridge</b><br> <p> The Woo Fridge Project aims to help people struggling with food insecurity in the Worcester area. There are three fridges which are continually stocked by members of the community located around Worcester. Those in need of food can travel to the fridge closest to them to find groceries they need. This fridge is located on Southbridge Street near Miss Worcester Diner.</p> <br> <p>44 Portland St Worcester, MA</p> <br> <a href= https://www.worcestercommunityfridges.com/ /> Here is the website </a>").openPopup();
    ...
    var fridge_marker3 = L.marker([42.259909, -71.802153], {icon: fridge_icon1}).addTo(fridge);{}
        fridge_marker3.bindPopup("<b>Portland Fridge</b><br> <p> The Woo Fridge Project aims to help people struggling with food insecurity in the Worcester area. There are three fridges which are continually stocked by members of the community located around Worcester. Those in need of food can travel to the fridge closest to them to find groceries they need. This fridge is located on Portland Street near City Hall. </p> <br> <p>16 Brooks St Worcester, MA</p> <br> <a href= https://www.worcestercommunityfridges.com/ /> Here is the website </a>").openPopup();
    ...
    var fridge_marker4 = L.marker([42.250940, -71.790360], {icon: fridge_icon1}).addTo(fridge);{}
         fridge_marker4.bindPopup("<b>Union Hill School</b><br> <p>Location: 42 South St Worcester, MA The Woo Fridge Project aims to help people struggling with food insecurity in the Worcester area. There are four fridges which are continually stocked by members of the community located around Worcester. Those in need of food can travel to the fridge closest to them to find groceries they need. This fridge is located on Portland Street near City Hall. </p> <br> <a href= https://www.worcestercommunityfridges.com/ /> Here is the website </a>").openPopup();

...
var fridge_icon1 = L.icon({
    ...
    var fridge_marker1 = L.marker([42.251710, -71.820060], {icon: fridge_icon1}).addTo(fridge);{}
          fridge_marker1.bindPopup("<b>Fantastic Pizza</b><br> <p>The Woo Fridge Project aims to help people struggling with food insecurity in the Worcester area. There are four fridges which are continually stocked by members of the community located around Worcester. Those in need of food can travel to the fridge closest to them to find groceries they need. This fridge is located on Main Street near Clark University.<br> <p>Location:910 Main St Worcester, MA</p> <br> <a href= https://www.worcestercommunityfridges.com/ /> Here is the website </a>").openPopup();
          fridge_marker1.on("click", function(e) {
          map.setView(e.latlng, 14);
          fridge_marker1.bounce({duration: 500, height: 100}, function(){console.log("done")});
          });

    var fridge_marker2 = L.marker([42.259710, -71.801950], {icon: fridge_icon1}).addTo(fridge);{}
        fridge_marker2.bindPopup("<b>The Printer Building</b><br> <p>The Woo Fridge Project aims to help people struggling with food insecurity in the Worcester area. There are four fridges which are continually stocked by members of the community located around Worcester. Those in need of food can travel to the fridge closest to them to find groceries they need. This fridge is located on Southbridge Street near Miss Worcester Diner.<br> <p>Location:44 Portland St Worcester, MA</p> <br> <a href= https://www.worcestercommunityfridges.com/ /> Here is the website </a>").openPopup();
        fridge_marker2.on("click", function(e) {
        map.setView(e.latlng, 14);
        fridge_marker2.bounce({duration: 500, height: 100}, function(){console.log("done")});
        });

    var fridge_marker3 = L.marker([42.309970, -71.799830], {icon: fridge_icon1}).addTo(fridge);{}
        fridge_marker3.bindPopup("<b>Massachusetts League of Community Health Centers</b><br> <p>The Woo Fridge Project aims to help people struggling with food insecurity in the Worcester area. There are four fridges which are continually stocked by members of the community located around Worcester. Those in need of food can travel to the fridge closest to them to find groceries they need. This fridge is located on Portland Street near City Hall.<br> <p>Location: 16 Brooks St Worcester, MA</p> <br> <a href= https://www.worcestercommunityfridges.com/ /> Here is the website </a>").openPopup();
   ...
   var fridge_marker4 = L.marker([42.250940, -71.790360], {icon: fridge_icon1}).addTo(fridge);{}
        fridge_marker4.bindPopup("<b>Union Hill School</b><br> <p>The Woo Fridge Project aims to help people struggling with food insecurity in the Worcester area. There are four fridges which are continually stocked by members of the community located around Worcester. Those in need of food can travel to the fridge closest to them to find groceries they need. This fridge is located on Portland Street near City Hall.<br> <p>Location: 42 South St Worcester, MA</p> <br> <a href= https://www.worcestercommunityfridges.com/ /> Here is the website </a>").openPopup();
...
var hc_icon1 = L.icon({
      ...
      var hc_marker1 = L.marker([42.273568, -71.748091], {icon: hc_icon1}).addTo(healthcare);{}
        hc_marker1.bindPopup("<b>St. Annes Free Medical Program</b><br> <p> St. Anne's Free Medical Program is a free healthcare service that aims to help the underserved and the uninsured in the Worcester area. Located in Shrewsbury, they have been operational since 1996. </p> <br> <p> 130 Boston Turnpike, Shrewsbury, MA 01545 </p> <br> <a href= http://www.stannesparish.org/clinic.php /> Here is the website </a>").openPopup();
      ...
      var hc_marker4 = L.marker([42.257428, -71.804695], {icon: hc_icon1}).addTo(healthcare);{}
        hc_marker4.bindPopup("<b>AIDS Project Worcester Inc</b><br> <p> The AIDS Project Worcester is a non-profit that offers a variety of services for those affected by the AIDS virus as well at at-risk members of the LGBTQ community. </p> <br> <p> 165 Southbridge Street, Worcester, MA 01608 </p> <br> <a href= https://www.aidsprojectworcester.org/ /> Here is the website </a>").openPopup();
